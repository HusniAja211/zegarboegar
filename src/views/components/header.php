    ...
    background-repeat: no-repeat;" class="bg-white shadow-md">
        <div class="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
            ...
            <ul class="hidden md:flex space-x-6 text-gray-700 font-medium">
                ...
                <li><a href="/member" class="hover:text-blue-600">Member</a></li>
                <li><a href="/kategori" class="hover:text-blue-600">Kategori</a></li>
                <li><a href="/produk" class="hover:text-blue-600">Produk</a></li>
                <li><a href="/laporan" class="hover:text-blue-600">Laporan</a></li>
                <li><a href="/keranjang" class="hover:text-blue-600">Keranjang</a></li>
            </ul>
